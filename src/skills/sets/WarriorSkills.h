...
namespace WarriorSkills{
    ...
    SkillClass torsionalImpact = SkillClass("Колющий удар", 1, 100, 10, SkillElement::NON_ELEMENT, true);
    SkillClass lightStrike = SkillClass("Удар с вертухи", 1, 200, 50, SkillElement::NON_ELEMENT, false);
